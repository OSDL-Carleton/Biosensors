...
def create_console_log_frame(parent):
    frame_output = tk.LabelFrame(parent, text="Console Log", relief=tk.SUNKEN, borderwidth=2)
    frame_output.pack(fill="both", padx=10, pady=5, expand=True)

    output_text = tk.Text(frame_output, height=5, width=45, wrap="none", bg='white')
