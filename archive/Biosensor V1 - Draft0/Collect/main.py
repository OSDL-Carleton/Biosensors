...
line2, = ax.plot([], [], 'b-', label='Y2-axis line in blue')
...
short_btn = ttk.Button(duration_frame, text="Short", command=lambda: set_duration("short"), style='TButton')
short_btn.grid(row=0, column=0, padx=5)

medium_btn = ttk.Button(duration_frame, text="Medium", command=lambda: set_duration("medium"), style='TButton')
medium_btn.grid(row=0, column=1, padx=5)

long_btn = ttk.Button(duration_frame, text="Long", command=lambda: set_duration("long"), style='TButton')
...
sweep_start_entry = ttk.Entry(sweep_voltage_frame, width=10, style='TEntry')
...
sweep_end_entry = ttk.Entry(sweep_voltage_frame, width=10, style='TEntry')
...
sweep_step_voltage_entry = ttk.Entry(step_settings_frame, width=10, style='TEntry')
...
step_entry = ttk.Entry(step_settings_frame, width=10, style='TEntry')
...
x_axis_label = ttk.Label(channel_selection_frame, text="X-axis:", style='TLabel')
x_axis_label.grid(row=0, column=0, padx=5)
x_axis_channels = ['V1 (V)', 'V2 (V)', 'V3 (V)', 'I4 (A)', 'I5 (A)', 'I6 (A)']
x_axis_combobox = ttk.Combobox(channel_selection_frame, values=x_axis_channels, style='TCombobox')
x_axis_combobox.grid(row=0, column=1, padx=5)
x_axis_combobox.set('V2 (V)')

y_axis_label = ttk.Label(channel_selection_frame, text="Y1-axis:", style='TLabel')
y_axis_label.grid(row=1, column=0, padx=5)
y_axis_channels = ['V1 (V)', 'V2 (V)', 'V3 (V)', 'I4 (A)', 'I5 (A)', 'I6 (A)']
y_axis_combobox = ttk.Combobox(channel_selection_frame, values=y_axis_channels, style='TCombobox')
y_axis_combobox.grid(row=1, column=1, padx=5)
y_axis_combobox.set('I4 (A)')

# Y2-axis Label and Combobox
y2_axis_label = ttk.Label(channel_selection_frame, text="Y2-axis:", style='TLabel')
y2_axis_label.grid(row=2, column=0, padx=5)
y2_axis_channels = ['V1 (V)', 'V2 (V)', 'V3 (V)', 'I4 (A)', 'I5 (A)', 'I6 (A)']
y2_axis_combobox = ttk.Combobox(channel_selection_frame, values=y2_axis_channels, style='TCombobox')
...
dac1_voltage_entry = ttk.Entry(dac1_voltage_frame, width=10, style='TEntry')
...
collect_btn = ttk.Button(btn_frame, text="Collect Data", command=start_data_collection, style='TButton')
collect_btn.grid(row=0, column=0, padx=10)

stop_btn = ttk.Button(btn_frame, text="Stop", command=stop_data_collection, style='TButton')
stop_btn.grid(row=0, column=1, padx=10)

reset_btn = ttk.Button(btn_frame, text="Reset", command=reset_data_collection, style='TButton')
reset_btn.grid(row=0, column=2, padx=10)

# The voltage and current labels within controls_frame
voltage1_label = ttk.Label(controls_frame, text="", style='TLabel')
voltage1_label.grid(row=6, column=0, pady=10)

voltage2_label = ttk.Label(controls_frame, text="", style='TLabel')
voltage2_label.grid(row=7, column=0, pady=10)

voltage3_label = ttk.Label(controls_frame, text="", style='TLabel')
voltage3_label.grid(row=8, column=0, pady=10)

current4_label = ttk.Label(controls_frame, text="", style='TLabel')
current4_label.grid(row=9, column=0, pady=10)

current5_label = ttk.Label(controls_frame, text="", style='TLabel')
current5_label.grid(row=10, column=0, pady=10)

current6_label = ttk.Label(controls_frame, text="", style='TLabel')
...
y_min_label = ttk.Label(y_axis_limits_frame, text="Y-axis Min:", style='TLabel')
y_min_label.grid(row=0, column=0, padx=5)
y_min_entry = ttk.Entry(y_axis_limits_frame, width=10, style='TEntry')
y_min_entry.grid(row=0, column=1, padx=5)
y_min_entry.insert(0, "0")  # Default minimum Y-axis

y_max_label = ttk.Label(y_axis_limits_frame, text="Y-axis Max:", style='TLabel')
y_max_label.grid(row=1, column=0, padx=5)
y_max_entry = ttk.Entry(y_axis_limits_frame, width=10, style='TEntry')
